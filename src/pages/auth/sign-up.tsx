...
export function SignUp() {
  ...
  async function handleSigUp(data: SigUpForm) {
    try {
      console.log(data);
          ...
          <div>
            <form onSubmit={handleSubmit(handleSigUp)} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="restaurantName">Nome do estabelecimentol</Label>
                <Input
                  id="restaurantName"
                  type="text"
              ...
              <p className="px-6 text-center text-sm leading-relaxed text-muted-foreground">
                {" "}
                Ao continuar, voce concorda com nossos termos de serviço e
                privacidade.
              </p>
            </form>
          </div>
